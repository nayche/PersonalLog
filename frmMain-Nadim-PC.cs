        ...
        private void btnModify_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dgvPLog.Rows.Count == 0 || dgvPLog.SelectedRows.Count > 1)
                {
                    ...
                    Utilities.WarningMsgBox("There are no selected records to modify");
                ...
                if (MultipleRecords(dRow,dstPLog1.PersonalLog))
                {
                    Utilities.WarningMsgBox("This record already exists in database.\n" + "Data not saved.");
                    return;
                }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                try
                {
                    ...
                    int currentdgvRowIndex = this.dgvPLog.CurrentRow.Index;     // only to be used later on when selecting a new row in the datagridview
